...
spriteSheet.src = 'assets/img/knight.png'; // Sti til dit spritesheet-billede
...
function animateSprite() {
  ...
  ctx.drawImage(spriteSheet, 0, currentFrame * frameHeight, frameWidth, frameHeight, 0, 0, frameWidth, frameHeight);
